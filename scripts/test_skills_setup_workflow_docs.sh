...
require_text "Status: catalog-dispositions-finalized"
require_text "Last updated: 2026-07-14"
...
require_text "gemini-files-api"
require_text 'When installing `meeting-transcription`'
require_text "bash ~/.agents/skills/gemini-files-api/scripts/bootstrap.sh"
...
require_text "scripts/skills_provenance_audit.rb --markdown"
