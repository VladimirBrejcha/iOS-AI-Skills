...
node public-source-release-audit/scripts/public-source-release-audit.mjs --repo .
node --test public-source-release-audit/tests/public-source-release-audit.test.mjs
