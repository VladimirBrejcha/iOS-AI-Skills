...
`spec-creation-updating`, and `ios-xcodegen` also have narrow reviewed Claude
Code baselines through `~/.claude/skills`. Other Claude Code skills and
repo-local consumers still include planned or manual-review coverage until
